          ...
          child: pw.Row(
            children: [
              ...
              if (showName)
                pw.Expanded(
                  flex: 4,
                  child: pw.Text('Item Name', style: pw.TextStyle(font: fontBold, fontSize: 10, color: PdfColors.white)),
                ),
              if (showPayment)
                pw.Expanded(
                  flex: 3,
                  child: pw.Text('Payment Method', style: pw.TextStyle(font: fontBold, fontSize: 10, color: PdfColors.white)),
                ),
              if (showQty)
                pw.SizedBox(
                  width: 44,
                  child: pw.Align(
                    ...
                    child: pw.Text('Qty', style: pw.TextStyle(font: fontBold, fontSize: 10, color: PdfColors.white)),
                  ),
                ),
              if (showPrice)
                pw.SizedBox(
                  ...
                  child: pw.Align(
                    ...
                    child: pw.Text('Price', style: pw.TextStyle(font: fontBold, fontSize: 10, color: PdfColors.white)),
                  ),
                ),
              if (showTotal)
                pw.SizedBox(
                  ...
                  child: pw.Align(
                    alignment: pw.Alignment.centerRight,
                    child: pw.Text('Total', style: pw.TextStyle(font: fontBold, fontSize: 10, color: PdfColors.white)),
                  ),
                ),
            ],
          ),
            ...
            child: pw.Row(
              children: [
                ...
                if (showName)
                  pw.Expanded(
                    flex: 4,
                    child: pw.Text(item.itemName ?? 'N/A', style: pw.TextStyle(font: fontMedium, fontSize: 12, color: _dark)),
                  ),
                if (showPayment)
                  pw.Expanded(
                    flex: 3,
                    child: pw.Text(item.paymentMethodName ?? 'N/A', style: pw.TextStyle(font: font, fontSize: 11, color: PdfColor(0.45, 0.45, 0.45))),
                  ),
                if (showQty)
                  pw.SizedBox(
                    width: 44,
                    child: pw.Align(
                      alignment: pw.Alignment.center,
                      child: pw.Text('${item.qty ?? 0}', style: pw.TextStyle(font: font, fontSize: 12, color: PdfColor(0.45, 0.45, 0.45))),
                    ),
                  ),
                if (showPrice)
                  pw.SizedBox(
                    ...
                    child: pw.Align(
                      ...
                      child: pw.Text('\u20B9${(item.unitPrice ?? 0).toStringAsFixed(2)}',
                          style: pw.TextStyle(font: font, fontSize: 12, color: PdfColor(0.45, 0.45, 0.45))),
                    ),
                  ),
                if (showTotal)
                  pw.SizedBox(
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          pw.Text(
            'Notes',
            style: pw.TextStyle(font: fontBold, fontSize: 11, color: _grey, letterSpacing: 1),
          ),
          pw.SizedBox(height: 6),
          pw.Text(bill.notes ?? '', style: pw.TextStyle(font: font, fontSize: 13, color: PdfColor(0.45, 0.45, 0.45))),
        ],
      ),
    );
  }
        ...
        pw.Expanded(
          child: pw.Column(
            ...
            children: [
              pw.Text(
                'PAYMENT INFORMATION',
                style: pw.TextStyle(font: fontBold, fontSize: 10, color: _grey, letterSpacing: 1),
              ),
              pw.SizedBox(height: 6),
              pw.Text(
                bill.paymentInfo ?? 'N/A',
                style: pw.TextStyle(font: font, fontSize: 13, color: PdfColor(0.45, 0.45, 0.45)),
              ),
              pw.SizedBox(height: 16),
              pw.Text(
                'My Name',
