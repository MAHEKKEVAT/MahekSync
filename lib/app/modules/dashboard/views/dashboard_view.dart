            ...
            () => AnimatedContainer(
              ...
              child: _GlassmorphicNavShell(
                ...
                child: _buildSideNavigation(
                  context,
                  theme,
                  widget.controller.isNavExpanded.value,
                ),
              ),
            ),
          ),
                          ...
                          child: InkWell(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: isSelected
                                    ? (isDark
                                          ? AppThemeData.primary50.withValues(
                                              alpha: 0.22,
                                            )
                                          : AppThemeData.primary50.withValues(
                                              alpha: 0.14,
              ...
              child: ClipRRect(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: AppThemeData.primaryBlack.withValues(
                  ...
                  child: AnimatedSwitcher(
                    ...
                    child: Obx(
                      () => KeyedSubtree(
                        ...
                        child: widget.controller.getPageWidget(
          ...
          child: Stack(
            children: [
              ...
              ...List.generate(18, (i) {
                ...
                final twinkle =
                    (math.sin(_starAnim.value * math.pi * 2 + i * 0.7) + 1) / 2;
                return Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: AppThemeData.primaryWhite.withValues(
                        alpha: twinkle * 0.45 + 0.1,
                      ),
        ...
        children: [
          ...
          Positioned.fill(
            child: BackdropFilter(
              ...
              child: Container(
                color: widget.isDark
                    ? AppThemeData.surfaceDeep.withValues(alpha: 0.82)
                    : AppThemeData.primaryWhite.withValues(alpha: 0.80),
              ),
            ),
          ),
          // Content
              ...
              border: widget.borderRadius != null
                  ? Border.all(
                      color: widget.isDark
                          ...
                          : AppThemeData.primaryWhite.withValues(alpha: 0.5),
                      width: 1,
                    )
                  : null,
            ),
...
class _GlassmorphicHeaderShell extends StatefulWidget {
  ...
  const _GlassmorphicHeaderShell({required this.child, required this.isDark});

  @override
  State<_GlassmorphicHeaderShell> createState() =>
      _GlassmorphicHeaderShellState();
}
  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: widget.isDark
              ? AppThemeData.surfaceDeep.withValues(alpha: 0.88)
              : AppThemeData.primaryWhite.withValues(alpha: 0.82),
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: widget.isDark
                ? AppThemeData.surfaceBorder.withValues(alpha: 0.3)
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              fontFamily: FontFamily.medium,
              fontSize: 12,
              color: AppThemeData.primaryWhite.withValues(alpha: 0.65),
            ),
          ),
          spaceW(width: 12),
          // Time with hour glow
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    ...
                    fontSize: 18,
                    height: 1,
                    color: AppThemeData.primaryWhite.withValues(alpha: 0.95),
                  ),
                ),
                // Animated colon
